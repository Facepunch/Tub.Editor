...
public class NetAnimation : Networked, INetworkStatic
{
    ...
    public virtual void Update()
    {
        ...
        UpdateToTime( (Delta * AnimationClip.length) +  (Time.realtimeSinceStartup * Speed), true );
    }
...
[UnityEditor.CustomEditor( typeof( NetAnimation ) )]
public class NetAnimationEditor : UnityEditor.Editor
{
    ...
    static void DrawNetAnimation( NetAnimation obj, UnityEditor.GizmoType gizmoType )
    {
